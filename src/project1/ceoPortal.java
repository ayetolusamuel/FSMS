...
import java.util.*;
public class ceoPortal extends JFrame
{
	...
	ceoPortal()
	{
		...
		JLabel l=new JLabel("<html><i><font size=5 color=#800080><i>CEO Portal");
		...
		JButton daily_Report=addButton("Transaction Report",handler);
		...
		JButton staff_contact=addButton("Staff List",handler);
		staff_contact.setBorder(BorderFactory.createBevelBorder(1, new Color(100, 100, 155), new Color(100, 100, 155)));
		JButton gest_contact=addButton("Weekly/Monthly Report",handler);
