...
public class MainMenuFrame extends JFrame
{
	...
	MainMenuFrame()
	{
		...
		JButton emergency_contact=addButton(" ",handler);
		emergency_contact.setText("<html><b><i>About The Software");
		emergency_contact.setFont(new Font("Times New Roman",Font.ITALIC,18));
		...
		JButton student_info=addButton(" ",handler);
		student_info.setText("<html><b><i>Staff Information");
		student_info.setFont(new Font("Times New Roman",Font.ITALIC,18));
		student_info.setBorder(BorderFactory.createBevelBorder(1, new Color(100, 100, 155), new Color(100, 100, 155)));
		JButton internal_report=addButton(" ",handler);
		internal_report.setText("<html><b>Admin Daily Record<i>");
		internal_report.setFont(new Font("Times New Roman",Font.ITALIC,18));
		internal_report.setBorder(BorderFactory.createBevelBorder(1, new Color(100, 100, 155), new Color(100, 100, 155)));
		JButton memo_form=addButton("",handler);
		memo_form.setText("<html><b><i>Expenditure");
		memo_form.setFont(new Font("Times New Roman",Font.ITALIC,18));
		memo_form.setBorder(BorderFactory.createBevelBorder(1, new Color(100, 100, 155), new Color(100, 100, 155)));
		JButton invetation_form=addButton("",handler);
		invetation_form.setText("<html><b><i>Payroll System");
		invetation_form.setFont(new Font("Times New Roman",Font.ITALIC,18));
		...
		staff_contact.setText("<html><b><i>Discharge");
		staff_contact.setFont(new Font("Times New Roman",Font.ITALIC,18));
		staff_contact.setBorder(BorderFactory.createBevelBorder(1, new Color(100, 100, 155), new Color(100, 100, 155)));
		JButton md_Portal=addButton("",handler);
		md_Portal.setText("<html><b><i>MD Portal");
		md_Portal.setFont(new Font("Times New Roman",Font.ITALIC,18));
		...
		gest_contact.setText("<html><b><i>CEO Portal");
		gest_contact.setFont(new Font("Times New Roman",Font.ITALIC,18));
		gest_contact.setBorder(BorderFactory.createBevelBorder(1, new Color(100, 100, 155), new Color(100, 100, 155)));
		
		JButton report=addButton("",handler);
		report.setText("<html><b><i>Staff's Report");
		report.setFont(new Font("Times New Roman",Font.ITALIC,18));
		report.setBorder(BorderFactory.createBevelBorder(1, new Color(100, 100, 155), new Color(100, 100, 155)));

		JButton logout=addButton("",handler);
		logout.setText("<html><b><i>LOGOUT");
		logout.setFont(new Font("Times New Roman",Font.ITALIC,18));
		...
		exit.setText("<html><b><i>Exit");
		exit.setFont(new Font("Times New Roman",Font.ITALIC,18));
...
con=getContentPane();
		...
		con.add( new c2(),BorderLayout.NORTH);
	...
	class ImagePanel extends JPanel
	{
		...
		public void paintComponent(Graphics g)
		{
			...
			Image img=Toolkit.getDefaultToolkit().getImage("images//stat.jpg");
	...
	class ButtonHandler implements ActionListener
	{
		public void actionPerformed(ActionEvent e)
		{
			...
			if(action.equals("<html><b><i>Staff Information"))
			{
			...
			if(action.equals("<html><b><i>Discharge"))
			{
			...
			//admindailyrecord
			if(action.equals("<html><b>Admin Daily Record<i>"))
			{
				admindailyrecord report=new admindailyrecord();
				report.setVisible(true);
				report.setSize(570,390);
				report.setLocationRelativeTo(null);
				setVisible(false);
			}
			
			
			if(action.equals("<html><b><i>Staff's Report"))
			{
			...
			if(action.equals("<html><b><i>Payroll System"))
			{
			...
			if(action.equals("<html><b><i>About The Software"))
			{
			...
			if(action.equals("<html><b><i>MD Portal"))
			{
			...
			if(action.equals("<html><b><i>CEO Portal"))
			{
				mdLogin sa=new mdLogin();
				sa.setVisible(true);
				sa.setSize(400,250);
			...
			if(action.equals("<html><b><i>LOGOUT"))
			{
			...
			if(action.equals("<html><b><i>Expenditure"))
			{
			...
			if(action.equals("<html><b><i>Exit"))
				System.exit(0);
...
public static void main(String args []){
	MainMenuFrame sa=new MainMenuFrame();
	sa.setVisible(true);
	sa.setLocationRelativeTo(null);
