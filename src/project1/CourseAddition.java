...
class CourseAddition extends JFrame
{
	...
	CourseAddition()
	{
		...
		main = new JPanel()
		{
			...
			{
				Toolkit kit=Toolkit.getDefaultToolkit();
				Image img=kit.getImage("images//cors.jpg");
				MediaTracker t=new MediaTracker(this);
				t.addImage(img,1);
				while(true)
				{
		...
		try
		{
			DataInputStream dt=new DataInputStream(new FileInputStream("images//courid.dat"));
	...
	class CourseEntry
	{
		...
		public void saveSub()
		{
			...
			try
			{
				...
				dout=new DataOutputStream(new FileOutputStream(cname+"_images//id.dat"));
				...
				DataOutputStream out=new DataOutputStream(new FileOutputStream("images//courid.dat"));
				out.writeUTF(temp2);
				dt.close();
				out.close();
			}
